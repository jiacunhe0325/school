    ...
    <div className="flex h-screen bg-[#030712] font-sans selection:bg-indigo-500/30 overflow-hidden text-slate-300">
      ...
      <aside className="w-64 border-r border-white/5 bg-white/[0.02] flex flex-col z-20 shrink-0 overflow-y-auto custom-scrollbar">
        ...
        <div className="p-4 flex flex-col gap-1.5 pb-24">
          ...
          <SidebarItem icon={Shield} label="角色权限" active={activeTab === 'roles'} onClick={() => setActiveTab('roles')} />
                      ...
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          <div className="flex items-center gap-2 mb-1">
                            ...
                            <span className={`text-xs px-2 py-0.5 rounded border ${student.type.includes('波动') ? 'bg-orange-500/10 text-orange-400 border-orange-500/30' : 'bg-purple-500/10 text-purple-400 border-purple-500/30'
                              }`}>
                              {student.type}
                            </span>
                          </div>
            ...
            <div className="space-y-6 animate-fade-in max-w-6xl mx-auto pb-10 font-sans">
              ...
              <div className="grid grid-cols-3 gap-6">
                <div className="col-span-2 space-y-6">
                  {/* Top Stats */}
                  <div className="bg-[#02120d] border border-teal-500/30 rounded-3xl p-6 relative overflow-hidden shadow-2xl">
                    ...
                    <div className="space-y-4">
                      <div className="bg-teal-900/20 border border-teal-500/20 rounded-xl p-4">
                        ...
                        <div className="h-2 bg-white/5 rounded-full overflow-hidden">
                          <div className="h-full bg-teal-400 w-[65%] rounded-full shadow-[0_0_10px_#2dd4bf] relative overflow-hidden">
                            <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/30 to-transparent -translate-x-full animate-[shimmer_2s_infinite]"></div>
                          </div>
                        </div>
                      </div>

                      <div className="bg-yellow-900/10 border border-yellow-500/20 rounded-xl p-4 transition-all">
                        ...
                        {isRecalculating ? (
                           <div className="mt-3 flex items-center gap-2 text-yellow-500 text-xs font-bold bg-yellow-500/10 w-fit px-3 py-1.5 rounded-lg border border-yellow-500/20">
                             <div className="w-3 h-3 border-2 border-yellow-500 border-t-transparent rounded-full animate-spin"></div> AI 正在重新分配解空间并平滑冲突...
                           </div>
                        ) : (
                          <button 
                            onClick={() => {
                            ...
                            className="mt-3 px-3 py-1.5 bg-yellow-500/20 text-yellow-300 text-xs border border-yellow-500/30 rounded-lg hover:bg-yellow-500/30 transition-colors"
                          >
                            采纳 AI 建议并重算
                          </button>
                        )}
                  ...
                  <div className="bg-white/[0.03] border border-white/10 rounded-3xl p-6">
                    <h4 className="font-bold text-white mb-4 flex items-center gap-2"><Calendar className="w-5 h-5 text-teal-400" /> 高二年级 (部分走班组) 本周排课切片预览</h4>
                    <div className="overflow-x-auto">
                      <table className="w-full text-center text-xs border-collapse">
                        <thead>
                          <tr>
                            <th className="p-2 border border-white/10 bg-white/5 text-slate-400 font-medium">节次</th>
                            <th className="p-2 border border-white/10 bg-white/5 text-slate-400 font-medium w-1/5">周一</th>
                            <th className="p-2 border border-white/10 bg-white/5 text-slate-400 font-medium w-1/5">周二</th>
                            <th className="p-2 border border-white/10 bg-white/5 text-slate-400 font-medium w-1/5">周三</th>
                            <th className="p-2 border border-white/10 bg-white/5 text-slate-400 font-medium w-1/5">周四</th>
                            <th className="p-2 border border-white/10 bg-white/5 text-slate-400 font-medium w-1/5">周五</th>
                          </tr>
                        </thead>
                        <tbody>
                          <tr>
                            <td className="p-2 border border-white/10 bg-white/[0.02] text-slate-500">1</td>
                            <td className="p-2 border border-white/10 bg-blue-500/10 text-blue-300">语文<br/><span className="text-[10px] text-blue-400/50">李梅</span></td>
                            <td className="p-2 border border-white/10 bg-purple-500/10 text-purple-300">物理 (走1)<br/><span className="text-[10px] text-purple-400/50">陈强</span></td>
                            <td className="p-2 border border-white/10 bg-green-500/10 text-green-300">英语<br/><span className="text-[10px] text-green-400/50">Smith</span></td>
                            <td className="p-2 border border-white/10 bg-orange-500/10 text-orange-300">数学<br/><span className="text-[10px] text-orange-400/50">张伟</span></td>
                            <td className="p-2 border border-white/10 bg-rose-500/10 text-rose-300">历史 (走2)<br/><span className="text-[10px] text-rose-400/50">王芳</span></td>
                          </tr>
                          <tr>
                            <td className="p-2 border border-white/10 bg-white/[0.02] text-slate-500">2</td>
                            <td className="p-2 border border-white/10 bg-orange-500/10 text-orange-300">数学<br/><span className="text-[10px] text-orange-400/50">张伟</span></td>
                            <td className="p-2 border border-white/10 bg-teal-500/10 text-teal-300">化学 (走1)<br/><span className="text-[10px] text-teal-400/50">赵敏</span></td>
                            <td className="p-2 border border-white/10 bg-blue-500/10 text-blue-300">语文<br/><span className="text-[10px] text-blue-400/50">李梅</span></td>
                            <td className="p-2 border border-white/10 bg-purple-500/10 text-purple-300">物理 (走1)<br/><span className="text-[10px] text-purple-400/50">陈强</span></td>
                            <td className="p-2 border border-white/10 bg-green-500/10 text-green-300">英语<br/><span className="text-[10px] text-green-400/50">Smith</span></td>
                          </tr>
                          <tr>
                            <td colSpan="6" className="py-1 border border-white/10 bg-white/5 text-[10px] text-slate-500 tracking-widest uppercase">大课间 / 眼保健操</td>
                          </tr>
                          <tr>
                            <td className="p-2 border border-white/10 bg-white/[0.02] text-slate-500">3</td>
                            <td className="p-2 border border-white/10 bg-green-500/10 text-green-300">英语<br/><span className="text-[10px] text-green-400/50">Smith</span></td>
                            <td className="p-2 border border-white/10 bg-rose-500/10 text-rose-300">历史 (走2)<br/><span className="text-[10px] text-rose-400/50">王芳</span></td>
                            <td className="p-2 border border-white/10 bg-orange-500/10 text-orange-300">数学<br/><span className="text-[10px] text-orange-400/50">张伟</span></td>
                            <td className="p-2 border border-white/10 bg-teal-500/10 text-teal-300">化学 (走1)<br/><span className="text-[10px] text-teal-400/50">赵敏</span></td>
                            <td className="p-2 border border-white/10 bg-yellow-500/10 text-yellow-300">体育<br/><span className="text-[10px] text-yellow-400/50">刘洋</span></td>
                          </tr>
                        </tbody>
                      </table>
                    </div>
                ...
                <div className="col-span-1 flex flex-col gap-6">
                  <div className="bg-white/[0.03] border border-white/10 rounded-3xl p-6 flex-1">
                    <h4 className="font-bold text-white mb-4 flex items-center gap-2"><Settings className="w-5 h-5 text-teal-400" /> 代课临时调度流转</h4>
                    <div className="space-y-3">
                      <div className="p-4 bg-red-500/10 border border-red-500/20 rounded-xl relative overflow-hidden group">
                        <div className="absolute top-0 right-0 p-2 opacity-10 group-hover:opacity-20 transition-opacity"><User className="w-12 h-12 text-red-500" /></div>
                        <div className="text-sm font-bold text-red-400 mb-1">张伟 (数学) - 突发病假</div>
                        <div className="text-xs text-slate-300 mb-3">今日第 4 节 (高一3班)</div>
                        <button 
                          onClick={() => setShowSubstituteModal(true)}
                          className="w-full py-2 bg-red-500/20 hover:bg-red-500/30 text-red-300 font-bold rounded-lg text-xs border border-red-500/30 transition-colors flex justify-center items-center gap-2"
                        >
                          <Bot className="w-4 h-4" /> AI 智能代课推荐
                        </button>
                      </div>
                      <div className="p-4 bg-white/5 border border-white/10 rounded-xl relative overflow-hidden">
                        <div className="absolute top-0 right-0 w-1 h-full bg-slate-500/30"></div>
                        <div className="text-sm font-bold text-slate-300 mb-1">李华 (英语) - 外出教研</div>
                        <div className="text-xs text-slate-400 mb-2">明日第 1,2 节调课至周四</div>
                        <div className="text-xs text-green-400 flex items-center gap-1"><CheckCircle2 className="w-3 h-3" /> 已自动通知学生与家长端</div>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div className="space-y-6 animate-fade-in max-w-6xl mx-auto pb-10">
               ...
               <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                 <div className="bg-gradient-to-br from-purple-500/10 to-transparent border border-purple-500/20 rounded-2xl p-6 relative overflow-hidden">
                   ...
                   <div className="text-sm font-medium text-purple-300 mb-2">高频打扰预警 (近7天)</div>
                   <div className="flex items-end gap-3">
                     <span className="text-4xl font-black text-white">12</span>
                     <span className="text-sm text-slate-400 mb-1">次非工作时间群发</span>
                   </div>
                 </div>
                 <div className="bg-white/[0.03] border border-white/10 rounded-2xl p-6 relative overflow-hidden">
                   <div className="absolute top-0 right-0 p-4 opacity-10"><Search className="w-16 h-16" /></div>
                   <div className="text-sm font-medium text-slate-400 mb-2">沟通盲区雷达</div>
                   <div className="flex items-end gap-3">
                     <span className="text-4xl font-black text-white">45</span>
                     <span className="text-sm font-bold text-orange-400 mb-1 flex items-center">名学生 {`>30天`}未沟通</span>
                   </div>
                 </div>
                 <div className="bg-rose-500/10 border border-rose-500/20 rounded-2xl p-6 relative overflow-hidden">
                   <div className="absolute top-0 right-0 p-4 opacity-10"><ShieldCheck className="w-16 h-16" /></div>
                   <div className="text-sm font-medium text-rose-300 mb-2">舆情敏感词拦截</div>
                   <div className="flex items-end gap-3">
                     <span className="text-4xl font-black text-rose-400">3</span>
                     <span className="text-sm text-rose-300/70 mb-1">条记录触发审核</span>
                   </div>
                 </div>
               </div>

               <div className="grid grid-cols-3 gap-6">
                 {/* Left Column: Polls & Sentiment (span 2) */}
                 <div className="col-span-2 bg-[#0f172a] border border-purple-500/20 rounded-3xl p-6 shadow-2xl relative overflow-hidden">
                   <div className="absolute top-0 right-0 w-64 h-64 bg-purple-500/10 rounded-full blur-[80px]"></div>
                   
                   <div className="flex justify-between items-center mb-6 relative z-10">
                     <h4 className="text-lg font-bold text-white flex items-center gap-2">
                       <BarChart2 className="w-5 h-5 text-purple-400"/> 民意问卷与 AI 满意度报告
                     </h4>
                     <div className="flex bg-white/5 rounded-lg p-1">
                       <button 
                         className={`px-4 py-1.5 rounded-md text-sm font-medium transition-colors ${pollFilter === 'all' ? 'bg-purple-500 text-white' : 'text-slate-400 hover:text-white'}`}
                         onClick={() => setPollFilter('all')}
                       >全部</button>
                       <button 
                         className={`px-4 py-1.5 rounded-md text-sm font-medium transition-colors ${pollFilter === 'active' ? 'bg-purple-500 text-white' : 'text-slate-400 hover:text-white'}`}
                         onClick={() => setPollFilter('active')}
                       >收集进行中</button>
                       <button 
                         className={`px-4 py-1.5 rounded-md text-sm font-medium transition-colors ${pollFilter === 'done' ? 'bg-purple-500 text-white' : 'text-slate-400 hover:text-white'}`}
                         onClick={() => setPollFilter('done')}
                       >已截稿</button>
                     </div>
                   </div>
                   ...
                   <div className="space-y-4 relative z-10">
                     {[
                       { id: 'P1', title: '关于调整冬季晚自习作息时间的征求意见', status: 'done', count: '3,842', target: '全校家长', aiSummary: '78% 的家长支持新作息方案，但走读生家长普遍担忧晚间交通安全，部分建议增设校车路线。' },
                       { id: 'P2', title: '2024 上半学期食堂餐饮服务满意度年度调查', status: 'active', count: '1,205', target: '全校师生及家长', aiSummary: '目前满意度均值 82分。焦点差评集中于“二楼清真窗口排队时间过长”及“晚餐菜品保温不足”。' },
                       { id: 'P3', title: '初一年级“数字平板”进课堂家长意向摸底', status: 'done', count: '450', target: '初一新生家长', aiSummary: '支持率极高(91%)。家长最关心的点在于“如何控制平板游戏时间”及“保护视力”。' },
                     ].filter(p => pollFilter === 'all' || (pollFilter === 'active' && p.status === 'active') || (pollFilter === 'done' && p.status === 'done')).map(poll => (
                       <div key={poll.id} className="p-5 bg-white/5 border border-white/10 rounded-2xl hover:bg-white/10 transition-colors">
                         <div className="flex justify-between items-start mb-3">
                           <div>
                             <h5 className="font-bold text-white text-base mb-1">{poll.title}</h5>
                             <div className="flex items-center gap-3 text-xs text-slate-400">
                               <span className={`px-2 py-0.5 rounded border ${poll.status === 'active' ? 'bg-green-500/10 text-green-400 border-green-500/20' : 'bg-slate-500/20 text-slate-300 border-slate-500/30'}`}>
                                 {poll.status === 'active' ? '收集中' : '已截稿'}
                               </span>
                               <span>对象: {poll.target}</span>
                               <span>回收: {poll.count} 份</span>
                             </div>
                           </div>
                           <button className="px-4 py-2 bg-purple-500/10 hover:bg-purple-500 hover:text-white text-purple-400 text-sm font-bold rounded-xl transition-colors border border-purple-500/30">
                             查看完整报告
                           </button>
                         </div>
                         <div className="bg-purple-900/20 border border-purple-500/20 rounded-xl p-3 flex gap-3">
                           <Bot className="w-5 h-5 text-purple-400 shrink-0 mt-0.5"/>
                           <div>
                             <div className="text-xs font-bold text-purple-300 mb-1">AI 舆情摘要核心结论：</div>
                             <p className="text-sm text-purple-100/80 leading-relaxed">{poll.aiSummary}</p>
                           </div>
                         </div>
                       </div>
                     ))}
                 ...
                 <div className="bg-white/[0.03] border border-white/10 rounded-3xl p-6 flex flex-col">
                   <h4 className="font-bold text-white mb-4 flex items-center gap-2">
                     <AlertTriangle className="w-5 h-5 text-orange-400"/> 风险行为干预工单
                   </h4>
                   <div className="space-y-4 flex-1">
                     <div className="bg-black/40 border border-orange-500/30 rounded-2xl p-4 relative overflow-hidden">
                       <div className="absolute top-0 left-0 w-1 h-full bg-orange-500"></div>
                       <div className="flex justify-between items-start mb-2">
                         <span className="text-sm font-bold text-white">深夜打扰预警</span>
                         <span className="text-xs text-slate-500">昨天 23:35</span>
                       </div>
                       <p className="text-xs text-slate-300 mb-3">高一(2)班班主任 <span className="font-bold text-indigo-300">王强</span> 在班级群发送群通知：“明天的作业请注意...”。</p>
                       <div className="flex gap-2">
                         <button className="flex-1 py-1.5 bg-orange-500/20 hover:bg-orange-500/30 text-orange-400 text-xs font-bold rounded-lg border border-orange-500/30 transition-colors">内部提醒规范</button>
                         <button className="px-3 py-1.5 bg-white/5 hover:bg-white/10 text-slate-400 text-xs font-bold rounded-lg transition-colors">忽略</button>
                       </div>
                     </div>

                     <div className="bg-black/40 border border-red-500/30 rounded-2xl p-4 relative overflow-hidden">
                       <div className="absolute top-0 left-0 w-1 h-full bg-red-500"></div>
                       <div className="flex justify-between items-start mb-2">
                         <span className="text-sm font-bold text-white">敏感词拦截 (费用)</span>
                         <span className="text-xs text-slate-500">今天 09:12</span>
                       </div>
                       <p className="text-xs text-slate-300 mb-3">初三(5)班家委会代表尝试在官方群发布：“由于需要统一购买复习资料，请大家转账...”。已被网关拦截。</p>
                       <div className="flex gap-2">
                         <button className="flex-1 py-1.5 bg-red-500/20 hover:bg-red-500/30 text-red-400 text-xs font-bold rounded-lg border border-red-500/30 transition-colors">联系班主任核实</button>
                       </div>
                     </div>
                   </div>
      ...
      {showSubstituteModal && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/60 backdrop-blur-sm p-6">
          <div className="w-full max-w-lg bg-[#02120d] border border-teal-500/30 rounded-3xl p-8 shadow-2xl animate-slide-in-up relative overflow-hidden">
            <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-teal-500 to-emerald-400"></div>
            
            <div className="flex justify-between items-start mb-6">
              <div className="flex items-center gap-3">
                <div className="p-2 bg-teal-500/20 rounded-xl text-teal-400"><Bot className="h-6 w-6" /></div>
                <div>
                  <h3 className="text-xl font-bold text-white">AI 智能代课推荐引擎</h3>
                  <p className="text-xs text-teal-400/70 mt-1">分析数学教研组实时排课负荷与空闲时段</p>
                </div>
              </div>
              <button onClick={() => setShowSubstituteModal(false)} className="text-slate-500 hover:text-white transition-colors"><XCircle className="w-6 h-6" /></button>
            </div>

            <div className="bg-red-500/10 border border-red-500/20 rounded-xl p-4 mb-6">
              <div className="text-sm font-bold text-red-400">待调配任务：</div>
              <div className="text-xs text-slate-300 mt-1">张伟 (突发病假) - 今日第 4 节 (高一3班 数学)</div>
            </div>

            <div className="space-y-4 mb-8">
              <h4 className="text-sm font-bold text-slate-400 mb-2">算法推荐顺位 (基于硬约束过滤与软约束疲劳度评分)：</h4>
              
              {/* Rec 1 */}
              <div className="p-4 bg-teal-500/10 border border-teal-500/30 rounded-xl relative cursor-pointer hover:bg-teal-500/20 transition-all group">
                <div className="absolute top-3 right-3 text-xs font-black text-teal-400 bg-teal-500/20 px-2 py-1 rounded">极力推荐</div>
                <div className="flex items-center gap-3 mb-2">
                  <div className="w-8 h-8 rounded-full bg-slate-800 flex items-center justify-center text-sm font-bold text-slate-300">赵</div>
                  <div>
                    <div className="text-sm font-bold text-white">赵铁柱 (同高一数学组)</div>
                    <div className="text-xs text-slate-400">第 4 节无排课 | 本周课时负荷 75%</div>
                  </div>
                </div>
                <div className="w-full h-1 bg-white/10 rounded-full mt-3 overflow-hidden">
                   <div className="h-full bg-teal-400 w-[75%] rounded-full"></div>
                </div>
                <div className="mt-4 hidden group-hover:block animate-fade-in">
                  <button onClick={() => setShowSubstituteModal(false)} className="w-full py-2 bg-teal-500 hover:bg-teal-400 text-white font-bold rounded-lg text-sm shadow-[0_0_15px_rgba(20,184,166,0.4)] transition-colors">
                    确认派发代课通知
                  </button>
                </div>
              </div>
              ...
              {/* Rec 2 */}
              <div className="p-4 bg-white/5 border border-white/10 rounded-xl relative cursor-not-allowed opacity-70">
                <div className="absolute top-3 right-3 text-xs font-bold text-orange-400 bg-orange-500/10 border border-orange-500/20 px-2 py-1 rounded">不建议</div>
                <div className="flex items-center gap-3 mb-2">
                  <div className="w-8 h-8 rounded-full bg-slate-800 flex items-center justify-center text-sm font-bold text-slate-300">林</div>
                  <div>
                    <div className="text-sm font-bold text-white">林晓 (同高一数学组)</div>
                    <div className="text-xs text-slate-400">第 4 节无排课 | 本周课时负荷已达 98%</div>
                  </div>
                </div>
                <div className="w-full h-1 bg-white/10 rounded-full mt-3 overflow-hidden">
                   <div className="h-full bg-orange-500 w-[98%] rounded-full"></div>
                </div>
              </div>
              
              {/* Rec 3 */}
              <div className="p-4 bg-white/5 border border-white/10 rounded-xl relative cursor-not-allowed opacity-50 grayscale">
                <div className="absolute top-3 right-3 text-xs font-bold text-red-400 bg-red-500/10 border border-red-500/20 px-2 py-1 rounded">硬冲突</div>
                <div className="flex items-center gap-3 mb-2">
                  <div className="w-8 h-8 rounded-full bg-slate-800 flex items-center justify-center text-sm font-bold text-slate-300">王</div>
                  <div>
                    <div className="text-sm font-bold text-white">王建国 (高二数学组)</div>
                    <div className="text-xs text-slate-400">第 4 节正在上课 (高二5班)</div>
                  </div>
                </div>
              </div>
